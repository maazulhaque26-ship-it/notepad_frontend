...
const UpdateModal = ({title , handelTitleChange , value , handleUpdateNote}) => {
  return (
    <>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary" onClick={handleUpdateNote}>Save changes</button>
                        </div>
                    </div>
                </div>
            </div>
